...
## Especies con movilidad

* Es menos obvio que la posición espacial es importante para especies móviles, que pueden un apareamiento mas o menos aleatorio (panmíctica).
...
## De poblaciones panmícticas a metapoblaciones 2
...
* En las islas Aland de Finlandia, la Glanville fritillary se encuentra sólo en pequeñas praderas que contienen una o ambas de las dos especies de plantas, Plantago lanceolata y Veronica spicata, que sirven como anfitriones a la mariposa en su etapa larval (Hanski, 2011).
...
\begin{columns}[T]
    \begin{column}{.5\textwidth}
     {\includegraphics[width==\textwidth]{images/GlanFritMap.png}}
    \end{column}
    \begin{column}{.5\textwidth}
    \begin{itemize} 

    \item Mapa de la red de parches de hábitat en las islas Åland que indica la relativa abundancia de V. spicata en los prados (color más oscuro indica una mayor abundancia relativa de Verónica; valores promedio en 1993-2010). Sombreado gris muestra la tierra, y el resto es mar.
     \end{itemize}
...
\begin{columns}[T]
    ...
    \includegraphics[width=\textwidth]{images/GlanFrit.png}
    \end{column}
    \begin{column}{.6\textwidth}
    \begin{itemize}

    \item (A) Tamaño de Metapoblación a veces se cuantifica como el número de grupos de larvas
    ...
    \item (B) Número de extinciones y colonizaciones entre ≈ 1.600 prados encuestados
en 1993-2010. 

    \item (C) Las extinciones y colonizaciones de (B) vs ocupación de parches para el mismo período.
...
\centerline{\includegraphics[width=\textwidth]{images/ModelingProcess.png}}
