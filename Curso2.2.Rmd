...
* Isolineas de crecimiento cero - Nullclines 
	<center>
	![](images/twoPatchNull.png)
	</center>

	+ Negro: isolínea $n_1$, azul:isolínea $n_2$. Las líneas de puntos son las capacidades de carga. 

	+ Puesto que los tamaños de las poblaciones acopladas en equilibrio están dadas por la intersección de las líneas continuas, la dispersión hace que la abundancia en el parche de 1 sea menos de lo que ocurriría si existiera el parche en forma aislada, mientras que la abundancia en el parche 2 es mayor que ocurriría si existía el parche en forma aislada.
